 ...
 */
    ...
    public frameTest2(PassedQuestionnare a) throws IOException, Exception{
        initComponents();
        this.file = new FileReader("tests/test2.json");
        curUsr = a;
        obj = new JSONObject();
